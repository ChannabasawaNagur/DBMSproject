        ...
        signup.setOnClickListener(
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent("com.example.channabasaawa.qp.Main2Activity");
                                ...
                                .addOnCompleteListener(MainActivity.this, new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        ...
                                        if (!task.isSuccessful()) {
                                            ...
                                            // Intent intent2 = new Intent("com.example.channabasaawa.qp.Main3Activity");
                                            //  startActivity(intent2);
                                            if (mymail.toLowerCase().contains(student.toLowerCase())) {
                                                Intent intent2 = new Intent(MainActivity.this, ViewUploadsActivity.class);
